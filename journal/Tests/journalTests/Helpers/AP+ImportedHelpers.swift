...
public func AssertDump<T: ParsableArguments, ToolInfoVersion: Codable & Equatable>(
  for _: T.Type, equals expected: String, for toolInfoVersion: ToolInfoVersion.Type,
  file: StaticString = #file, line: UInt = #line
) throws {
  do {
    ...
    try AssertJSONEqualFromString(actual: dumpString, expected: expected, for: toolInfoVersion)
  }

  try AssertJSONEqualFromString(actual: T._dumpHelp(), expected: expected, for: toolInfoVersion)
}
...
extension XCTest {
  ...
  public func AssertJSONOutputEqual<ToolInfoVersion:Codable & Equatable>(
    command: String,
    expected: String,
    toolInfoVersion: ToolInfoVersion.Type,
    file: StaticString = #file, line: UInt = #line
  ) throws {
    ...
    try AssertJSONEqualFromString(actual: outputString, expected: expected, for: ToolInfoVersion.self)
  }
}
